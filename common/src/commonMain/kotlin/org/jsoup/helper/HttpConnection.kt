...
import jsoup.HttpStatusException
import jsoup.UncheckedIOException
import jsoup.UnsupportedMimeTypeException
 ...
 */
class HttpConnection : jsoup.Connection {
    /**
    ...
    private var res: jsoup.Connection.Response? = null
    public override fun newRequest(): jsoup.Connection {
    ...
    public override fun url(url: URL?): jsoup.Connection {
        req.url(url)
        return this
    }

    public override fun url(url: String?): jsoup.Connection {
    ...
    public override fun proxy( proxy: Proxy?): jsoup.Connection {
        req.proxy(proxy)
        return this
    }

    public override fun proxy(host: String?, port: Int): jsoup.Connection {
        req.proxy(host, port)
        return this
    }

    public override fun userAgent(userAgent: String?): jsoup.Connection {
        Validate.notNull(userAgent, "User agent must not be null")
        req.header(USER_AGENT, userAgent)
        return this
    }

    public override fun timeout(millis: Int): jsoup.Connection {
        req.timeout(millis)
        return this
    }

    public override fun maxBodySize(bytes: Int): jsoup.Connection {
        req.maxBodySize(bytes)
        return this
    }

    public override fun followRedirects(followRedirects: Boolean): jsoup.Connection {
        req.followRedirects(followRedirects)
        return this
    }

    public override fun referrer(referrer: String?): jsoup.Connection {
        Validate.notNull(referrer, "Referrer must not be null")
        req.header("Referer", referrer)
        return this
    }

    public override fun method(method: jsoup.Connection.Method?): jsoup.Connection {
        req.method((method)!!)
        return this
    }

    public override fun ignoreHttpErrors(ignoreHttpErrors: Boolean): jsoup.Connection {
        req.ignoreHttpErrors(ignoreHttpErrors)
        return this
    }

    public override fun ignoreContentType(ignoreContentType: Boolean): jsoup.Connection {
        req.ignoreContentType(ignoreContentType)
        return this
    }

    public override fun data(key: String?, value: String?): jsoup.Connection {
        req.data(KeyVal.create(key, value))
        return this
    }

    public override fun sslSocketFactory(sslSocketFactory: SSLSocketFactory?): jsoup.Connection {
        req.sslSocketFactory(sslSocketFactory)
        return this
    }

    public override fun data(key: String?, filename: String?, inputStream: InputStream?): jsoup.Connection {
    ...
    public override fun data(data: Map<String?, String?>): jsoup.Connection {
    ...
    public override fun data(vararg keyvals: String?): jsoup.Connection {
    ...
    public override fun data(data: Collection<jsoup.Connection.KeyVal?>): jsoup.Connection {
        Validate.notNull(data, "Data collection must not be null")
        for (entry: jsoup.Connection.KeyVal? in data) {
            req.data(entry)
        }
        return this
    }

    public override fun data(key: String): jsoup.Connection.KeyVal? {
        Validate.notEmpty(key, "Data key must not be empty")
        for (keyVal: jsoup.Connection.KeyVal? in request().data()) {
            if ((keyVal!!.key() == key)) return keyVal
        }
        return null
    }

    public override fun requestBody(body: String?): jsoup.Connection {
        req.requestBody(body)
        return this
    }

    public override fun header(name: String?, value: String?): jsoup.Connection {
        req.header((name)!!, value)
        return this
    }

    public override fun headers(headers: Map<String?, String?>): jsoup.Connection {
    ...
    public override fun cookie(name: String?, value: String?): jsoup.Connection {
        req.cookie((name)!!, (value)!!)
        return this
    }

    public override fun cookies(cookies: Map<String?, String?>): jsoup.Connection {
    ...
    public override fun cookieStore(cookieStore: CookieStore?): jsoup.Connection {
    ...
    public override fun parser(parser: Parser?): jsoup.Connection {
        req.parser(parser)
        return this
    }
    ...
    public override fun get(): Document? {
        req.method(jsoup.Connection.Method.GET)
        execute()
    ...
    public override fun post(): Document? {
        req.method(jsoup.Connection.Method.POST)
        execute()
        Validate.notNull(res)
        return res!!.parse()
    }
    ...
    @Throws(IOException::class)
    public override fun execute(): jsoup.Connection.Response? {
        res = Response.execute(req)
        return res
    }

    public override fun request(): jsoup.Connection.Request {
        return req
    }

    public override fun request(request: jsoup.Connection.Request): jsoup.Connection {
        req =
    ...
    public override fun response(): jsoup.Connection.Response {
        if (res == null) {
    ...
    public override fun response(response: jsoup.Connection.Response?): jsoup.Connection {
        res = response
        return this
    }

    public override fun postDataCharset(charset: String?): jsoup.Connection {
        req.postDataCharset(charset)
        return this
    }

    abstract class Base<T : jsoup.Connection.Base<T>?> : jsoup.Connection.Base<T> {
        var url: URL? = UnsetUrl
        var method: jsoup.Connection.Method = jsoup.Connection.Method.GET
        ...
        public override fun method(): jsoup.Connection.Method {
            return method
        }

        public override fun method(method: jsoup.Connection.Method): T {
    ...
    class Request : Base<jsoup.Connection.Request?>, jsoup.Connection.Request {
        private var proxy: Proxy? = null
        private var timeoutMilliseconds: Int
        private var maxBodySizeBytes: Int
        private var followRedirects: Boolean
        private val data: MutableCollection<jsoup.Connection.KeyVal?>
        ...
        internal constructor() : super() {
            ...
            data = ArrayList()
            method = jsoup.Connection.Method.GET
        ...
        public override fun maxBodySize(bytes: Int): jsoup.Connection.Request {
        ...
        public override fun followRedirects(followRedirects: Boolean): jsoup.Connection.Request {
        ...
        public override fun ignoreHttpErrors(ignoreHttpErrors: Boolean): jsoup.Connection.Request {
        ...
        public override fun ignoreContentType(ignoreContentType: Boolean): jsoup.Connection.Request {
            this.ignoreContentType = ignoreContentType
            return this
        }

        public override fun data(keyval: jsoup.Connection.KeyVal?): Request {
            Validate.notNull(keyval, "Key val must not be null")
            data.add(keyval)
            return this
        }

        public override fun data(): MutableCollection<jsoup.Connection.KeyVal?> {
            return data
        }

        public override fun requestBody( body: String?): jsoup.Connection.Request {
            this.body = body
            return this
        }
        ...
        public override fun postDataCharset(charset: String?): jsoup.Connection.Request {
    ...
    class Response : Base<jsoup.Connection.Response?>, jsoup.Connection.Response {
        ...
        public override fun bufferUp(): jsoup.Connection.Response {
            prepareByteData()
            return this
        }
        ...
        private constructor(conn: HttpURLConnection, request: Request,  previousResponse: Response?) {
            this.conn = conn
            req = request
            method = jsoup.Connection.Method.valueOf(conn.getRequestMethod())
            url = conn.getURL()
         ...
         */
                ...
                try {
                    ...
                    if (res.hasHeader(LOCATION) && req.followRedirects()) {
                        if (status != HTTP_TEMP_REDIR) {
                            req.method(jsoup.Connection.Method.GET) // always redirect with a get. any data param from original req are dropped.
                            req.data().clear()
                    ...
                    if (conn.getContentLength() != 0 && req.method() != jsoup.Connection.Method.HEAD) { // -1 means unknown, chunked. sun throws an IO exception on 500 response with no content when trying to read body
                        res.bodyStream =
            ...
            private fun setOutputContentType(req: jsoup.Connection.Request): String? {
            ...
            @Throws(IOException::class)
            private fun writePost(req: jsoup.Connection.Request, outputStream: OutputStream, boundary: String?) {
                val data: Collection<jsoup.Connection.KeyVal?>? = req.data()
                val w: BufferedWriter =
                    BufferedWriter(OutputStreamWriter(outputStream, Charset.forName(req.postDataCharset())))
                if (boundary != null) {
                    // boundary will be set if we're in multipart mode
                    for (keyVal: jsoup.Connection.KeyVal? in data!!) {
                        w.write("--")
                        w.write(boundary)
                        w.write("\r\n")
            ...
            @Throws(IOException::class)
            private fun serialiseRequestUrl(req: jsoup.Connection.Request) {
                val `in`: URL? = req.url()
                ...
                for (keyVal: jsoup.Connection.KeyVal? in req.data()) {
    ...
    class KeyVal private constructor(key: String?, value: String?) : jsoup.Connection.KeyVal {
        ...
        public override fun contentType(contentType: String?): jsoup.Connection.KeyVal {
    ...
    companion object {
         ...
         */
        fun connect(url: String?): jsoup.Connection {
            val con: jsoup.Connection = HttpConnection()
            con.url(url)
            return con
        }
         ...
         * @return a new Connection object
         */
        fun connect(url: URL?): jsoup.Connection {
            val con: jsoup.Connection = HttpConnection()
            con.url(url)
            return con
        }
        ...
        private fun needsMultipart(req: jsoup.Connection.Request): Boolean {
