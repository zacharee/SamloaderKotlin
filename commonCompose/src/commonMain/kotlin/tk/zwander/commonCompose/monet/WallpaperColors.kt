...
class WallpaperColors {
     ...
     * @see WallpaperColors.fromBitmap
     * @see WallpaperColors.fromDrawable
     */
    constructor(
    ...
    val secondaryColor: Color?
         ...
         */
        get() = if (mMainColors.size < 2) null else mMainColors.get(1)
    ...
    val tertiaryColor: Color?
         ...
         * @return A color, may be null.
         */
        get() = if (mMainColors.size < 3) null else mMainColors.get(2)
    ...
    override fun equals(o: Any?): Boolean {
        ...
        val other = o as WallpaperColors
        return ((mMainColors == other.mMainColors) && (mAllColors == other.mAllColors) && (colorHints == other.colorHints))
    }
    ...
    companion object {
        private val DEBUG_DARK_PIXELS = false
         ...
         */
        val HINT_SUPPORTS_DARK_TEXT = 1 shl 0
        ...
        private val MAX_WALLPAPER_EXTRACTION_AREA = MAX_BITMAP_SIZE * MAX_BITMAP_SIZE

        // When extracting the main colors, only consider colors
        // present in at least MIN_COLOR_OCCURRENCE of the image
        private val MIN_COLOR_OCCURRENCE = 0.05f

        // Decides when dark theme is optimal for this wallpaper
        private val DARK_THEME_MEAN_LUMINANCE = 0.3f

        // Minimum mean luminosity that an image needs to have to support dark text
        private val BRIGHT_IMAGE_MEAN_LUMINANCE = 0.7f

        // We also check if the image has dark pixels in it,
        // to avoid bright images with some dark spots.
        private val DARK_PIXEL_CONTRAST = 5.5f
        private val MAX_DARK_AREA = 0.05f
        ...
        private fun colorToHueProportion(
            ...
            val colorToHueProportion: MutableMap<Int, Double> = HashMap<Int, Double>()
